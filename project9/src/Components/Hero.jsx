  ...
  return (
    <section className="relative max-w-[1280px] mx-auto px-6 md:px-16 pt-10 pb-32 text-center">
      ...
      <div className="mt-14 flex justify-center">
        <button onClick={() => navigate("/gallery")} className="flex items-center gap-3 border border-gray-300 px-6 py-3 rounded-full hover:bg-purple-300 hover:text-white transition hover:scale-98"> Create Magic

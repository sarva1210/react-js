    ...
    <section className="w-full py-16">
      <div className="containerx grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="rounded-2xl overflow-hidden shadowPro bg-white">
          <img className="w-full h-72 sm:h-96 object-cover" src="https://plus.unsplash.com/premium_photo-1661486971635-b79537d79d97?q=80&w=966&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="testimonial"/>
        </div>
        ...
        <div className="bg-[#0b2f44] text-white rounded-2xl p-8 shadowPro relative">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button onClick={prev} className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition">◀</button>
              <button onClick={next} className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition">▶</button>
            </div>
          </div>
          ...
          <FaQuoteRight className="absolute bottom-6 right-6 text-white/20" size={30}/>
        </div>
      </div>
    </section>
  )

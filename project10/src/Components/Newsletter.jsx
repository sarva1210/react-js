        ...
        <div className="bg-[#0b2f44] rounded-3xl p-8 md:p-10 shadowPro flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            <input
              ...
              className="w-full text-white sm:w-80 px-4 py-3 rounded-2xl outline-none"
              placeholder="Enter your email"
            />
            <button className="px-6 py-3 rounded-2xl bg-white text-[#0b2f44] font-bold hover:bg-slate-200 transition active:scale-95">
              Submit
            </button>
          </form>
        </div>

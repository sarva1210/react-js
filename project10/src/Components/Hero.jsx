  ...
  return (
    <section className="w-full bg-[#f7f8fb] relative overflow-hidden">
      ...
      <div className="containerx pt-12 pb-20 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center relative z-10">
        <div>
          <h1 className="text-4xl sm:text-5xl font-extrabold leading-tight text-[#0b2f44]">
            Professional <br />
            <span className="text-slate-500">Security Services</span> <br />
            You Can Trust
          </h1>

          <p className="mt-5 text-slate-500 max-w-lg text-sm leading-relaxed">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed ut dolorem tempore
            incidunt ut reiciendis.
          </p>
          ...
          <div className="relative w-[290px] h-[290px] sm:w-[380px] sm:h-[380px] rounded-full bg-white shadowPro flex items-center justify-center">
            <div className="w-[240px] h-[240px] sm:w-[310px] sm:h-[310px] rounded-full bg-slate-100 overflow-hidden border border-slate-200">
              <img
                ...
                src="https://images.unsplash.com/photo-1580894908361-967195033215?auto=format&fit=crop&w=1000&q=60"
                alt="camera"
              />
            </div>
            ...
            <button
              ...
              className="absolute right-5 bottom-10 w-14 h-14 rounded-full bg-[#0b2f44] text-white flex items-center justify-center shadow-lg hover:bg-[#092636] transition active:scale-95"
            >

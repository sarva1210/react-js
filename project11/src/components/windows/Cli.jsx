...
const Cli = ({ windowName, setWindowsState }) => {
  ...
  const commands = {
    ...
    contact: {
      ...
      usage: 'contact',
      fn: () => `Email: sarva.vish77@gmail.com
    ...
    github: {
      ...
      usage: 'github',
      fn: () => {
        window.location.href = 'https://github.com/sarva1210'
    ...
    linkedin: {
      ...
      usage: 'linkedin',
      fn: () => {
        window.location.href = 'https://www.linkedin.com/in/sarva-vishwakarma'
    ...
    social: {
      ...
      usage: 'social',
      fn: () => `Twitter: sarva1210
      LinkedIn: https://www.linkedin.com/in/sarva-vishwakarma
      Portfolio: sarva1210`
    },
